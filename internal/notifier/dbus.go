...
// DBus posts desktop notifications via the org.freedesktop.Notifications DBus
// interface. Using DBus directly (instead of notify-send) lets us obtain the
// notification ID so we can dismiss it programmatically once the YubiKey has
// been touched.
type DBus struct{}
...
func (DBus) TouchNeeded(body string) (uint32, error) {
